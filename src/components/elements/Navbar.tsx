                        ...
                        >
                            {theme === "dark" ? (
                              ...
                              >
                                <path
                                    ...
                                    d="M21.752 15.002A9.718 9.718 0 0112 21.75 9.75 9.75 0 0112 2.25c.362 0 .717.021 1.064.063a.75.75 0 01.434 1.296 7.501 7.501 0 009.041 11.393.75.75 0 01.213 1.293z"
                                />
                              </svg>
                            ): (
                            <svg
                            ...
                            >
                                <path
                                  strokeLinecap="round"
                                  strokeLinejoin="round"
                                  d="M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25M17.364 18.364l-1.591-1.591M12 18.75V21m-4.773-4.227l-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z"
                                />
                                </svg>
                                )}
